...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Input Type Class</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.w3._1999.xhtml.XHTML11Package#getInputTypeClass()
 * @model extendedMetaData="name='xhtml.InputType.class'"
 * @generated
 */
public enum InputTypeClass implements Enumerator {
    /**
    ...
    /**
     * An array of all the '<em><b>Input Type Class</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    private static final InputTypeClass[] VALUES_ARRAY =
        new InputTypeClass[] {
            TEXT,
            PASSWORD,
            CHECKBOX,
    ...
    /**
     * A public read-only list of all the '<em><b>Input Type Class</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public static final List<InputTypeClass> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

    /**
     * Returns the '<em><b>Input Type Class</b></em>' literal with the specified literal value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public static InputTypeClass get(String literal) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            InputTypeClass result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>Input Type Class</b></em>' literal with the specified name.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @param name the name.
     * @return the matching enumerator or <code>null</code>.
     * @generated
     */
    public static InputTypeClass getByName(String name) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            InputTypeClass result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>Input Type Class</b></em>' literal with the specified integer value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public static InputTypeClass get(int value) {
        switch (value) {
     ...
     * @generated
     */
    private InputTypeClass(int value, String name, String literal) {
        this.value = value;
        this.name = name;
