/**
 */
package org.w3._1999.xhtml.datatypes.impl;
...
import org.w3._1999.xhtml.datatypes.*;
 ...
 * @generated
 */
public class XHTML11DatatypesFactoryImpl extends EFactoryImpl implements XHTML11DatatypesFactory {
    /**
     ...
     * @generated
     */
    public static XHTML11DatatypesFactory init() {
        try {
            XHTML11DatatypesFactory theXHTML11DatatypesFactory = (XHTML11DatatypesFactory)EPackage.Registry.INSTANCE.getEFactory(XHTML11DatatypesPackage.eNS_URI);
            if (theXHTML11DatatypesFactory != null) {
                return theXHTML11DatatypesFactory;
            }
        }
        catch (Exception exception) {
            EcorePlugin.INSTANCE.log(exception);
        }
        return new XHTML11DatatypesFactoryImpl();
    }
     ...
     * @generated
     */
    public XHTML11DatatypesFactoryImpl() {
        super();
    }
    ...
    public List<String> createCharsetsFromString(EDataType eDataType, String initialValue) {
        ...
        for (String item : split(initialValue)) {
            result.add(createCharsetFromString(XHTML11DatatypesPackage.Literals.CHARSET, item));
        }
        return result;
    }
    ...
    public String convertCharsetsToString(EDataType eDataType, Object instanceValue) {
        ...
        for (Object item : list) {
            result.append(convertCharsetToString(XHTML11DatatypesPackage.Literals.CHARSET, item));
            result.append(' ');
        }
    ...
    public String createColorFromString(EDataType eDataType, String initialValue) {
        ...
        try {
            result = createColorMember1FromString(XHTML11DatatypesPackage.Literals.COLOR_MEMBER1, initialValue);
            if (result != null && Diagnostician.INSTANCE.validate(eDataType, result, null, null)) {
                return result;
            }
        }
    ...
    public String convertColorToString(EDataType eDataType, Object instanceValue) {
        ...
        if (XHTML11DatatypesPackage.Literals.COLOR_MEMBER1.isInstance(instanceValue)) {
            try {
                String value = convertColorMember1ToString(XHTML11DatatypesPackage.Literals.COLOR_MEMBER1, instanceValue);
                if (value != null) return value;
            }
            catch (Exception e) {
                // Keep trying other member types until all have failed.
    ...
    public List<String> createCURIEsFromString(EDataType eDataType, String initialValue) {
        ...
        List<String> result = new ArrayList<String>();
        for (String item : split(initialValue)) {
            result.add(createCURIEFromString(XHTML11DatatypesPackage.Literals.CURIE, item));
        }
        return result;
    }
    ...
    public String convertCURIEsToString(EDataType eDataType, Object instanceValue) {
        ...
        StringBuffer result = new StringBuffer();
        for (Object item : list) {
            result.append(convertCURIEToString(XHTML11DatatypesPackage.Literals.CURIE, item));
            result.append(' ');
        }
        return result.substring(0, result.length() - 1);
    }
    ...
    public Object createFrameTargetFromString(EDataType eDataType, String initialValue) {
        ...
        RuntimeException exception = null;
        try {
            result = createFrameTargetMember0FromString(XHTML11DatatypesPackage.Literals.FRAME_TARGET_MEMBER0, initialValue);
            if (result != null && Diagnostician.INSTANCE.validate(eDataType, result, null, null)) {
                return result;
            }
        }
        ...
        try {
            result = createFrameTargetMember1FromString(XHTML11DatatypesPackage.Literals.FRAME_TARGET_MEMBER1, initialValue);
            if (result != null && Diagnostician.INSTANCE.validate(eDataType, result, null, null)) {
                return result;
            }
        }
    ...
    public String convertFrameTargetToString(EDataType eDataType, Object instanceValue) {
        if (instanceValue == null) return null;
        if (XHTML11DatatypesPackage.Literals.FRAME_TARGET_MEMBER0.isInstance(instanceValue)) {
            try {
                String value = convertFrameTargetMember0ToString(XHTML11DatatypesPackage.Literals.FRAME_TARGET_MEMBER0, instanceValue);
                if (value != null) return value;
            }
            catch (Exception e) {
                // Keep trying other member types until all have failed.
        ...
        if (XHTML11DatatypesPackage.Literals.FRAME_TARGET_MEMBER1.isInstance(instanceValue)) {
            try {
                String value = convertFrameTargetMember1ToString(XHTML11DatatypesPackage.Literals.FRAME_TARGET_MEMBER1, instanceValue);
                if (value != null) return value;
            }
            catch (Exception e) {
                // Keep trying other member types until all have failed.
    ...
    public FrameTargetMember0 createFrameTargetMember0ObjectFromString(EDataType eDataType, String initialValue) {
        return createFrameTargetMember0FromString(XHTML11DatatypesPackage.Literals.FRAME_TARGET_MEMBER0, initialValue);
    }
    ...
    public String convertFrameTargetMember0ObjectToString(EDataType eDataType, Object instanceValue) {
        return convertFrameTargetMember0ToString(XHTML11DatatypesPackage.Literals.FRAME_TARGET_MEMBER0, instanceValue);
    }
    ...
    public Object createLengthFromString(EDataType eDataType, String initialValue) {
        ...
        try {
            result = createLengthMember1FromString(XHTML11DatatypesPackage.Literals.LENGTH_MEMBER1, initialValue);
            if (result != null && Diagnostician.INSTANCE.validate(eDataType, result, null, null)) {
                return result;
            }
        }
    ...
    public String convertLengthToString(EDataType eDataType, Object instanceValue) {
        ...
        if (XHTML11DatatypesPackage.Literals.LENGTH_MEMBER1.isInstance(instanceValue)) {
            try {
                String value = convertLengthMember1ToString(XHTML11DatatypesPackage.Literals.LENGTH_MEMBER1, instanceValue);
                if (value != null) return value;
            }
            catch (Exception e) {
                // Keep trying other member types until all have failed.
    ...
    public Object createMultiLengthFromString(EDataType eDataType, String initialValue) {
        ...
        RuntimeException exception = null;
        try {
            result = createLengthFromString(XHTML11DatatypesPackage.Literals.LENGTH, initialValue);
            if (result != null && Diagnostician.INSTANCE.validate(eDataType, result, null, null)) {
                return result;
            }
        }
        ...
        try {
            result = createMultiLengthMember1FromString(XHTML11DatatypesPackage.Literals.MULTI_LENGTH_MEMBER1, initialValue);
            if (result != null && Diagnostician.INSTANCE.validate(eDataType, result, null, null)) {
                return result;
            }
        }
    ...
    public String convertMultiLengthToString(EDataType eDataType, Object instanceValue) {
        if (instanceValue == null) return null;
        if (XHTML11DatatypesPackage.Literals.LENGTH.isInstance(instanceValue)) {
            try {
                String value = convertLengthToString(XHTML11DatatypesPackage.Literals.LENGTH, instanceValue);
                if (value != null) return value;
            }
            catch (Exception e) {
                // Keep trying other member types until all have failed.
        ...
        if (XHTML11DatatypesPackage.Literals.MULTI_LENGTH_MEMBER1.isInstance(instanceValue)) {
            try {
                String value = convertMultiLengthMember1ToString(XHTML11DatatypesPackage.Literals.MULTI_LENGTH_MEMBER1, instanceValue);
                if (value != null) return value;
            }
            catch (Exception e) {
                // Keep trying other member types until all have failed.
    ...
    public List<String> createSafeCURIEsFromString(EDataType eDataType, String initialValue) {
        ...
        List<String> result = new ArrayList<String>();
        for (String item : split(initialValue)) {
            result.add(createSafeCURIEFromString(XHTML11DatatypesPackage.Literals.SAFE_CURIE, item));
        }
        return result;
    }
    ...
    public String convertSafeCURIEsToString(EDataType eDataType, Object instanceValue) {
        ...
        StringBuffer result = new StringBuffer();
        for (Object item : list) {
            result.append(convertSafeCURIEToString(XHTML11DatatypesPackage.Literals.SAFE_CURIE, item));
            result.append(' ');
        }
        return result.substring(0, result.length() - 1);
    }
    ...
    public String createURIorSafeCURIEFromString(EDataType eDataType, String initialValue) {
        ...
        try {
            result = createSafeCURIEFromString(XHTML11DatatypesPackage.Literals.SAFE_CURIE, initialValue);
            if (result != null && Diagnostician.INSTANCE.validate(eDataType, result, null, null)) {
                return result;
            }
        }
    ...
    public String convertURIorSafeCURIEToString(EDataType eDataType, Object instanceValue) {
        ...
        if (XHTML11DatatypesPackage.Literals.SAFE_CURIE.isInstance(instanceValue)) {
            try {
                String value = convertSafeCURIEToString(XHTML11DatatypesPackage.Literals.SAFE_CURIE, instanceValue);
                if (value != null) return value;
            }
            catch (Exception e) {
                // Keep trying other member types until all have failed.
    ...
    public List<String> createURIorSafeCURIEsFromString(EDataType eDataType, String initialValue) {
        ...
        List<String> result = new ArrayList<String>();
        for (String item : split(initialValue)) {
            result.add(createURIorSafeCURIEFromString(XHTML11DatatypesPackage.Literals.UR_IOR_SAFE_CURIE, item));
        }
        return result;
    }
    ...
    public String convertURIorSafeCURIEsToString(EDataType eDataType, Object instanceValue) {
        ...
        StringBuffer result = new StringBuffer();
        for (Object item : list) {
            result.append(convertURIorSafeCURIEToString(XHTML11DatatypesPackage.Literals.UR_IOR_SAFE_CURIE, item));
            result.append(' ');
        }
        return result.substring(0, result.length() - 1);
    }
     ...
     * @generated
     */
    public XHTML11DatatypesPackage getXHTML11DatatypesPackage() {
        return (XHTML11DatatypesPackage)getEPackage();
    }
     ...
     */
    @Deprecated
    public static XHTML11DatatypesPackage getPackage() {
        return XHTML11DatatypesPackage.eINSTANCE;
    }

} //XHTML11DatatypesFactoryImpl
