 ...
 * <!-- end-user-doc -->
 * @see org.w3._1999.xhtml.datatypes.XHTML11DatatypesPackage
 * @generated
 */
public class XHTML11DatatypesValidator extends EObjectValidator {
    /**
     ...
     * @generated
     */
    public static final XHTML11DatatypesValidator INSTANCE = new XHTML11DatatypesValidator();
     ...
     * @generated
     */
    public static final String DIAGNOSTIC_SOURCE = "org.w3._1999.xhtml.datatypes";
     ...
     * @generated
     */
    public XHTML11DatatypesValidator() {
        super();
    ...
    public boolean validateCharacter_MinLength(String character, DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        if (!result && diagnostics != null)
            reportMinLengthViolation(XHTML11DatatypesPackage.Literals.CHARACTER, character, length, 1, diagnostics, context);
        return result;
    }
    ...
    public boolean validateCharacter_MaxLength(String character, DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        boolean result = length <= 1;
        if (!result && diagnostics != null)
            reportMaxLengthViolation(XHTML11DatatypesPackage.Literals.CHARACTER, character, length, 1, diagnostics, context);
        return result;
    }
    ...
    public boolean validateCharsets_ItemType(List<?> charsets, DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        for (Iterator<?> i = charsets.iterator(); i.hasNext() && (result || diagnostics != null); ) {
            Object item = i.next();
            if (XHTML11DatatypesPackage.Literals.CHARSET.isInstance(item)) {
                result &= validateCharset((String)item, diagnostics, context);
            }
            else {
                result = false;
                reportDataValueTypeViolation(XHTML11DatatypesPackage.Literals.CHARSET, item, diagnostics, context);
            }
        }
        return result;
    }
    ...
    public boolean validateColor_MemberTypes(String color, DiagnosticChain diagnostics, Map<Object, Object> context) {
        if (diagnostics != null) {
            ...
            if (XHTML11DatatypesPackage.Literals.COLOR_MEMBER1.isInstance(color)) {
    ...
    public boolean validateColorMember1_Pattern(String colorMember1, DiagnosticChain diagnostics, Map<Object, Object> context) {
        return validatePattern(XHTML11DatatypesPackage.Literals.COLOR_MEMBER1, colorMember1, COLOR_MEMBER1__PATTERN__VALUES, diagnostics, context);
    }
    ...
    public boolean validateCURIE_Pattern(String curie, DiagnosticChain diagnostics, Map<Object, Object> context) {
        return validatePattern(XHTML11DatatypesPackage.Literals.CURIE, curie, CURIE__PATTERN__VALUES, diagnostics, context);
    }
    ...
    public boolean validateCURIE_MinLength(String curie, DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        boolean result = length >= 1;
        if (!result && diagnostics != null)
            reportMinLengthViolation(XHTML11DatatypesPackage.Literals.CURIE, curie, length, 1, diagnostics, context);
        return result;
    }
    ...
    public boolean validateCURIEs_ItemType(List<?> curiEs, DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        for (Iterator<?> i = curiEs.iterator(); i.hasNext() && (result || diagnostics != null); ) {
            Object item = i.next();
            if (XHTML11DatatypesPackage.Literals.CURIE.isInstance(item)) {
                result &= validateCURIE((String)item, diagnostics, context);
            }
            else {
                result = false;
                reportDataValueTypeViolation(XHTML11DatatypesPackage.Literals.CURIE, item, diagnostics, context);
            }
        }
        return result;
    }
    ...
    public boolean validateFrameTarget_MemberTypes(Object frameTarget, DiagnosticChain diagnostics, Map<Object, Object> context) {
        if (diagnostics != null) {
            BasicDiagnostic tempDiagnostics = new BasicDiagnostic();
            if (XHTML11DatatypesPackage.Literals.FRAME_TARGET_MEMBER0.isInstance(frameTarget)) {
                if (validateFrameTargetMember0((FrameTargetMember0)frameTarget, tempDiagnostics, context)) return true;
            }
            if (XHTML11DatatypesPackage.Literals.FRAME_TARGET_MEMBER1.isInstance(frameTarget)) {
    ...
    public boolean validateFrameTargetMember1_Pattern(String frameTargetMember1, DiagnosticChain diagnostics, Map<Object, Object> context) {
        return validatePattern(XHTML11DatatypesPackage.Literals.FRAME_TARGET_MEMBER1, frameTargetMember1, FRAME_TARGET_MEMBER1__PATTERN__VALUES, diagnostics, context);
    }
    ...
    public boolean validateLength_MemberTypes(Object length, DiagnosticChain diagnostics, Map<Object, Object> context) {
        if (diagnostics != null) {
            ...
            if (XHTML11DatatypesPackage.Literals.LENGTH_MEMBER1.isInstance(length)) {
    ...
    public boolean validateLengthMember1_Pattern(String lengthMember1, DiagnosticChain diagnostics, Map<Object, Object> context) {
        return validatePattern(XHTML11DatatypesPackage.Literals.LENGTH_MEMBER1, lengthMember1, LENGTH_MEMBER1__PATTERN__VALUES, diagnostics, context);
    }
    ...
    public boolean validateMultiLength_MemberTypes(Object multiLength, DiagnosticChain diagnostics, Map<Object, Object> context) {
        if (diagnostics != null) {
            BasicDiagnostic tempDiagnostics = new BasicDiagnostic();
            if (XHTML11DatatypesPackage.Literals.LENGTH.isInstance(multiLength)) {
                if (validateLength(multiLength, tempDiagnostics, context)) return true;
            }
            if (XHTML11DatatypesPackage.Literals.MULTI_LENGTH_MEMBER1.isInstance(multiLength)) {
    ...
    public boolean validateMultiLengthMember1_Pattern(String multiLengthMember1, DiagnosticChain diagnostics, Map<Object, Object> context) {
        return validatePattern(XHTML11DatatypesPackage.Literals.MULTI_LENGTH_MEMBER1, multiLengthMember1, MULTI_LENGTH_MEMBER1__PATTERN__VALUES, diagnostics, context);
    }
    ...
    public boolean validateSafeCURIE_Pattern(String safeCURIE, DiagnosticChain diagnostics, Map<Object, Object> context) {
        return validatePattern(XHTML11DatatypesPackage.Literals.SAFE_CURIE, safeCURIE, SAFE_CURIE__PATTERN__VALUES, diagnostics, context);
    }
    ...
    public boolean validateSafeCURIE_MinLength(String safeCURIE, DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        if (!result && diagnostics != null)
            reportMinLengthViolation(XHTML11DatatypesPackage.Literals.SAFE_CURIE, safeCURIE, length, 3, diagnostics, context);
        return result;
    }
    ...
    public boolean validateSafeCURIEs_ItemType(List<?> safeCURIEs, DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        for (Iterator<?> i = safeCURIEs.iterator(); i.hasNext() && (result || diagnostics != null); ) {
            Object item = i.next();
            if (XHTML11DatatypesPackage.Literals.SAFE_CURIE.isInstance(item)) {
                result &= validateSafeCURIE((String)item, diagnostics, context);
            }
            else {
                result = false;
                reportDataValueTypeViolation(XHTML11DatatypesPackage.Literals.SAFE_CURIE, item, diagnostics, context);
            }
        }
        return result;
    }
    ...
    public boolean validateURIorSafeCURIE_MemberTypes(String urIorSafeCURIE, DiagnosticChain diagnostics, Map<Object, Object> context) {
        if (diagnostics != null) {
            ...
            if (XHTML11DatatypesPackage.Literals.SAFE_CURIE.isInstance(urIorSafeCURIE)) {
    ...
    public boolean validateURIorSafeCURIEs_ItemType(List<?> urIorSafeCURIEs, DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        for (Iterator<?> i = urIorSafeCURIEs.iterator(); i.hasNext() && (result || diagnostics != null); ) {
            Object item = i.next();
            if (XHTML11DatatypesPackage.Literals.UR_IOR_SAFE_CURIE.isInstance(item)) {
                result &= validateURIorSafeCURIE((String)item, diagnostics, context);
            }
            else {
                result = false;
                reportDataValueTypeViolation(XHTML11DatatypesPackage.Literals.UR_IOR_SAFE_CURIE, item, diagnostics, context);
            }
        }
        return result;
    }
    ...
    public boolean validateURIREF_Pattern(String uriref, DiagnosticChain diagnostics, Map<Object, Object> context) {
        return validatePattern(XHTML11DatatypesPackage.Literals.URIREF, uriref, URIREF__PATTERN__VALUES, diagnostics, context);
    }
    ...
    public boolean validateURIREF_MinLength(String uriref, DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        boolean result = length >= 1;
        if (!result && diagnostics != null)
            reportMinLengthViolation(XHTML11DatatypesPackage.Literals.URIREF, uriref, length, 1, diagnostics, context);
        return result;
    }
