...
public class ScriptTypeImpl extends MinimalEObjectImpl.Container implements ScriptType {
    ...
    protected EClass eStaticClass() {
        return XHTML11Package.eINSTANCE.getScriptType();
    }
    ...
    public FeatureMap getMixed() {
        if (mixed == null) {
            mixed = new BasicFeatureMap(this, XHTML11Package.SCRIPT_TYPE__MIXED);
        }
        return mixed;
    }
    ...
    public void setCharset(String newCharset) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XHTML11Package.SCRIPT_TYPE__CHARSET, oldCharset, charset));
    }
    ...
    public void setDefer(DeferType newDefer) {
        ...
        deferESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XHTML11Package.SCRIPT_TYPE__DEFER, oldDefer, defer, !oldDeferESet));
    }
    ...
    public void unsetDefer() {
        ...
        deferESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, XHTML11Package.SCRIPT_TYPE__DEFER, oldDefer, DEFER_EDEFAULT, oldDeferESet));
    }
    ...
    public void setId(String newId) {
        ...
        id = newId;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XHTML11Package.SCRIPT_TYPE__ID, oldId, id));
    }
    ...
    public void setSrc(String newSrc) {
        ...
        src = newSrc;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XHTML11Package.SCRIPT_TYPE__SRC, oldSrc, src));
    }
    ...
    public void setType(String newType) {
        ...
        type = newType;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XHTML11Package.SCRIPT_TYPE__TYPE, oldType, type));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case XHTML11Package.SCRIPT_TYPE__MIXED:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case XHTML11Package.SCRIPT_TYPE__CHARSET:
                return getCharset();
            case XHTML11Package.SCRIPT_TYPE__DEFER:
                return getDefer();
            case XHTML11Package.SCRIPT_TYPE__ID:
                return getId();
            case XHTML11Package.SCRIPT_TYPE__SRC:
                return getSrc();
            case XHTML11Package.SCRIPT_TYPE__TYPE:
                return getType();
        }
