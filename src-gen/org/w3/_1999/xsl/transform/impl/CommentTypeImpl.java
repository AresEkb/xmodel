 ...
 * </p>
 * <ul>
 *   <li>{@link org.w3._1999.xsl.transform.impl.CommentTypeImpl#getSelect <em>Select</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommentTypeImpl extends SequenceConstructorImpl implements CommentType {
    /**
    ...
    protected EClass eStaticClass() {
        return XSLT20Package.Literals.COMMENT_TYPE;
    }
    ...
    public void setSelect(String newSelect) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XSLT20Package.COMMENT_TYPE__SELECT, oldSelect, select));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case XSLT20Package.COMMENT_TYPE__SELECT:
                return getSelect();
        }
