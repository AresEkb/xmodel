 ...
 * </p>
 * <ul>
 *   <li>{@link org.w3._1999.xsl.transform.impl.GenericElementTypeImpl#getMixed <em>Mixed</em>}</li>
 ...
 * @generated
 */
public class GenericElementTypeImpl extends MinimalEObjectImpl.Container implements GenericElementType {
    /**
    ...
    public FeatureMap getMixed() {
        if (mixed == null) {
            mixed = new BasicFeatureMap(this, XSLT20Package.GENERIC_ELEMENT_TYPE__MIXED);
        }
        return mixed;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case XSLT20Package.GENERIC_ELEMENT_TYPE__MIXED:
