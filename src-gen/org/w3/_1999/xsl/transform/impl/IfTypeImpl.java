 ...
 * </p>
 * <ul>
 *   <li>{@link org.w3._1999.xsl.transform.impl.IfTypeImpl#getTest <em>Test</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IfTypeImpl extends SequenceConstructorImpl implements IfType {
	/**
	...
	protected EClass eStaticClass() {
		return XSLT20Package.Literals.IF_TYPE;
	}
	...
	public void setTest(String newTest) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XSLT20Package.IF_TYPE__TEST, oldTest, test));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XSLT20Package.IF_TYPE__TEST:
				return getTest();
		}
