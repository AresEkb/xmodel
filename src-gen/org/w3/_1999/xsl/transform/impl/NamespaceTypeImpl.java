 ...
 * </p>
 * <ul>
 *   <li>{@link org.w3._1999.xsl.transform.impl.NamespaceTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.w3._1999.xsl.transform.impl.NamespaceTypeImpl#getSelect <em>Select</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NamespaceTypeImpl extends SequenceConstructorImpl implements NamespaceType {
	/**
	...
	protected EClass eStaticClass() {
		return XSLT20Package.Literals.NAMESPACE_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XSLT20Package.NAMESPACE_TYPE__NAME, oldName, name));
	}
	...
	public void setSelect(String newSelect) {
		...
		select = newSelect;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XSLT20Package.NAMESPACE_TYPE__SELECT, oldSelect, select));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XSLT20Package.NAMESPACE_TYPE__NAME:
				return getName();
			case XSLT20Package.NAMESPACE_TYPE__SELECT:
				return getSelect();
		}
