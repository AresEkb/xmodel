...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>With Param Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.w3._1999.xsl.transform.impl.WithParamTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.w3._1999.xsl.transform.impl.WithParamTypeImpl#getSelect <em>Select</em>}</li>
 *   <li>{@link org.w3._1999.xsl.transform.impl.WithParamTypeImpl#getAs <em>As</em>}</li>
 *   <li>{@link org.w3._1999.xsl.transform.impl.WithParamTypeImpl#getTunnel <em>Tunnel</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WithParamTypeImpl extends SequenceConstructorImpl implements WithParamType {
    /**
    ...
    protected EClass eStaticClass() {
        return XSLT20Package.Literals.WITH_PARAM_TYPE;
    }
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XSLT20Package.WITH_PARAM_TYPE__NAME, oldName, name));
    }
    ...
    public void setSelect(String newSelect) {
        ...
        select = newSelect;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XSLT20Package.WITH_PARAM_TYPE__SELECT, oldSelect, select));
    }
    ...
    public void setAs(String newAs) {
        ...
        as = newAs;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XSLT20Package.WITH_PARAM_TYPE__AS, oldAs, as));
    }
    ...
    public void setTunnel(YesOrNo newTunnel) {
        ...
        tunnelESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XSLT20Package.WITH_PARAM_TYPE__TUNNEL, oldTunnel, tunnel, !oldTunnelESet));
    }
    ...
    public void unsetTunnel() {
        ...
        tunnelESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, XSLT20Package.WITH_PARAM_TYPE__TUNNEL, oldTunnel, TUNNEL_EDEFAULT, oldTunnelESet));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case XSLT20Package.WITH_PARAM_TYPE__NAME:
                return getName();
            case XSLT20Package.WITH_PARAM_TYPE__SELECT:
                return getSelect();
            case XSLT20Package.WITH_PARAM_TYPE__AS:
                return getAs();
            case XSLT20Package.WITH_PARAM_TYPE__TUNNEL:
                return getTunnel();
        }
